...
<head>
    ...
    <title>Online Tire Size Finder</title>
                ...
                <div x-show="showQuoteForm" x-transition
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-sm text-gray-600 mb-4">
                            <span class="font-medium">Vehicle:</span> <span x-text="(results.vehicle && (results.vehicle.year + ' ' + results.vehicle.make + ' ' + results.vehicle.model)) || '—'"></span><br>
                            <span class="font-medium">Tire size:</span> <span x-text="results.fitment && (results.fitment.rear_tire && results.fitment.rear_tire !== results.fitment.front_tire ? results.fitment.front_tire + ' / ' + results.fitment.rear_tire : results.fitment.front_tire) || '—'"></span>
                        </p>
